...
if(len(sys.argv)>= 2):
    ...
    url = "https://patrimonioculturale.regione.emilia-romagna.it/novita/notizie"
...
all_descriptions = soup.find_all(class_=["card-text"])
...
feedTitle = "Novità Patrimonio Culturale Emilia-Romagna"
